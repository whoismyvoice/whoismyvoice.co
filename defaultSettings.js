const defaultSettings = {
  id: 1,
  bill_id: 'hr1599-114',
  bill_title: 'Vote against Obamacare',
  bill_desc: 'Did my #member vote to2',
  chamber: 'house',
  created_at: 1447686398,
  pre_text: 'Your #member_type, #member_name #action',
  ...
  voted_for: 'reverse Obamacare'
  voted_against: 'not reverse Obamacare'
};
