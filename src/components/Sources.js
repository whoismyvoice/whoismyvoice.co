    ...
    return  <div className="page-block light-white">
      ...
      <div className="page-wrapper">
        ...
        <p className="page-introduction">
          The data on this website is based on the data released by the Federal Election Commission on donations that were made during the 2015-2016 election cycle by the National Rifle Association of America Political Victory Fund Committee. Note that only donations above $200 need to be itemized.
          <br /><br />
