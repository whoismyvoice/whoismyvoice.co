      ...
      <div className="page-block light-white">
        ...
        <div className="page-wrapper">
          ...
          <p className="page-introduction">
            The data on this website is based on the data released by the Federal Election Commission (FEC) on donations that were made during the 2015-2016 and 2017-2018 election cycles. Only donations exceeding $200 in value are required to be publicly disclosed, i.e. (multiple) donations below $200 threshold do not need to be itemized. WhoIsMyVoice.com uses APIs provided by <a href="https://maplight.org/">MapLight</a> to search FEC data.
            <br /><br />
